...
Hero examples use the shared Showcase-only `Preview options` disclosure for optional preview controls. These controls are review tooling and are not part of reusable production layout components.
