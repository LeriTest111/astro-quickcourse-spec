...
Use this interaction when a learner should choose one option and receive immediate explanatory feedback. It is based on the K-Beauty Module 4 multiple-choice activity, but the component is neutral and data-driven.
